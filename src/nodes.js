...
const movieListLikedSection= document.querySelector('#liked');
...
const likedMoviesListArticle= document.querySelector('.liked__movieList');

// Elements
const arrowUpScroll= document.querySelector('.container__arrowUp');
...
const optionsLenguage= document.querySelector('#la');
